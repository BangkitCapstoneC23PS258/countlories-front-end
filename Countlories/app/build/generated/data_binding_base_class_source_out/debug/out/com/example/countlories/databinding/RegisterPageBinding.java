...
public final class RegisterPageBinding implements ViewBinding {
  ...
  private RegisterPageBinding(@NonNull ConstraintLayout rootView, @NonNull Button registerButton,
  ...
  public static RegisterPageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RegisterPageBinding((ConstraintLayout) rootView, registerButton,
