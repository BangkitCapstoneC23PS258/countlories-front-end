 ...
 */
public abstract class Hilt_LandingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LandingFragment() {
    super();
  }

  Hilt_LandingFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LandingFragment_GeneratedInjector) this.generatedComponent()).injectLandingFragment(UnsafeCasts.<LandingFragment>unsafeCast(this));
    }
  }
