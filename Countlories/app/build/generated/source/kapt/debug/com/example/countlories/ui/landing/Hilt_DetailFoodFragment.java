 ...
 */
public abstract class Hilt_DetailFoodFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DetailFoodFragment() {
    super();
  }

  Hilt_DetailFoodFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DetailFoodFragment_GeneratedInjector) this.generatedComponent()).injectDetailFoodFragment(UnsafeCasts.<DetailFoodFragment>unsafeCast(this));
    }
  }
