...
import com.example.countlories.di.AppModule_ProvideRepositoryFactory;
import com.example.countlories.di.AppModule_ProvidesApiFactory;
import com.example.countlories.di.AppModule_ProvidesApiMLFactory;
...
public final class DaggerMyApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MyApp_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(2).add(AuthViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(LandingViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
  ...
  private static final class ViewModelCImpl extends MyApp_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.landingViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 1);
    }

    @Override
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(2).put("com.example.countlories.ui.auth.AuthViewModel", ((Provider) authViewModelProvider)).put("com.example.countlories.ui.landing.LandingViewModel", ((Provider) landingViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.countlories.ui.auth.AuthViewModel 
